...
cmd = [sys.executable, '-B', '-m', 'pytest', 'tests/test_models.py', '-v', '--tb=short', '-p', 'no:anyio']
proc = subprocess.Popen(cmd, stdout=open(outfile, 'w'), stderr=subprocess.STDOUT, text=True)
try:
